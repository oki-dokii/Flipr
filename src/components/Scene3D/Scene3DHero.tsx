      ...
      <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex gap-4 z-10 items-center justify-center w-full px-4">
        ...
        >
          <Button
            variant="outline"
            size="xl"
            className="rounded-full bg-white/5 backdrop-blur-sm border-white/20 text-white font-semibold text-lg hover:bg-white/10 hover:scale-105 hover:border-white/40 transition-all duration-300 pointer-events-auto"
          >
