                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            {trucks.map((truck) => (
                                <div key={truck.id} className="glass-card p-6 hover:scale-105 transition-transform">
                                    ...
                                    {/* Analytics Section */}
                                    {(truck.total_trips || 0) > 0 && (
                                        <div className="mb-4 p-3 bg-background/30 rounded-lg">
                                            <p className="text-xs text-muted-foreground mb-2">Analytics:</p>
                                            <div className="grid grid-cols-3 gap-2 text-center">
                                                <div>
                                                    <div className="text-lg font-bold text-teal">{truck.total_trips || 0}</div>
                                                    <div className="text-xs text-muted-foreground">Trips</div>
                                                </div>
                                                <div>
                                                    <div className="text-lg font-bold text-cyan">{Math.round(truck.total_distance_km || 0)}</div>
                                                    <div className="text-xs text-muted-foreground">km</div>
                                                </div>
                                                <div>
                                                    <div className="text-lg font-bold text-green">{Math.round(truck.total_co2_saved_kg || 0)}</div>
